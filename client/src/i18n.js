export const STRINGS = {
  fr: {
    ...
    attrib:
      "Fond © OpenFreeMap · données © OpenStreetMap contributors · couches reçues : sources et licences des pipelines",
  ...
  en: {
    ...
    watermark: "NOT FOR NAVIGATION",
    attrib:
      "Basemap © OpenFreeMap · data © OpenStreetMap contributors · live layers: pipeline sources and licences",
